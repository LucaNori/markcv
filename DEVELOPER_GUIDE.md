...
├── data/                 # Data files
│   ├── cv.md             # Default CV template
│   └── template.tex      # LaTeX template (minimal)
...
- `/app/data`: Contains the CV markdown file and generated HTML
...
See the `PROJECT_DEVELOPMENT_PLAN.md` for a detailed roadmap of planned features and enhancements.
